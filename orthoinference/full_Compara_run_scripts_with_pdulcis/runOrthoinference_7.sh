...
# Existing Compara
projSpecies=(ptri pper smoe sita slyc stub sbic tcac tpra taes)
#=======
...
mysqldump --defaults-file=.my_ortho.cnf -h localhost test_slice_oryza_sativa_20_ortho_osat_all > ./mysql_ortho_dumps/test_slice_oryza_sativa_20_ortho_osat_all_7.sql
cp ./mysql_ortho_dumps/test_slice_oryza_sativa_20_ortho_osat_all_7.sql ~/Documents/projects/plant_reactome/releases/r63/mysql_db/
echo "Run 7"
