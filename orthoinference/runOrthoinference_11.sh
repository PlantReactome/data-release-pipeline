...
# New Compara
projSpecies=(oaus ogra omin ooff okas pdac pedu zjap pabi ptae)
#=======
...
mysqldump --defaults-file=.my_ortho.cnf -h localhost test_slice_oryza_sativa_20_ortho_osat_all_no_pdul > ./mysql_ortho_dumps/without_pdul/test_slice_oryza_sativa_20_ortho_osat_all_no_pdul_11.sql
cp ./mysql_ortho_dumps/without_pdul/test_slice_oryza_sativa_20_ortho_osat_all_no_pdul_11.sql ~/Documents/projects/plant_reactome/releases/r63/mysql_db/without_pdulcis/
echo "Run 11: Inparanoid projections complete (without P.dulcis)"
